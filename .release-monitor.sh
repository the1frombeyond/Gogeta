#!/usr/bin/env bash
# Release monitor for gogeta-build/gogeta-cli
# Checks every 15 minutes, writes new release info to a signal file

REPO="gogeta-build/gogeta-cli"
SIGNAL_FILE="/tmp/gogeta-new-release.json"
STATE_FILE="/tmp/gogeta-monitor-last-tag"
LOG_FILE="/tmp/gogeta-monitor.log"
